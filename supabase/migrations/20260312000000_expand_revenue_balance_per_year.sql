-- Migration: Expand revenue and balance_sheet_dre into individual year slots
--
-- Previously these were single checklist items with compound labels like
-- "Faturamento 2022, 2023, 2024 e 2025". Now each year gets its own slot
-- with reference_year set, matching the IRPF per-partner-per-year pattern.
