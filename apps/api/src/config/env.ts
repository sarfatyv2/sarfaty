...
const envSchema = z.object({
  ...
  S3_BUCKET_CLIENT_DOCS: z.string().default('snc-client-documents'),
  S3_BUCKET_COLLABORATOR_DOCS: z.string().default('snc-collaborator-documents'),
  S3_BUCKET_AVATARS: z.string().default('snc-avatars-documents'),
