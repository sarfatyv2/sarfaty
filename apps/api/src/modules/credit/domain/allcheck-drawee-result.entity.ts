export interface AllcheckDraweeResultProps {
  id: string;
  draweeId: string;
...
export class AllcheckDraweeResult {
  readonly id: string;
  ...
  private constructor(props: AllcheckDraweeResultProps) {
    this.id = props.id;
  ...
  static create(props: Omit<AllcheckDraweeResultProps, 'id' | 'queriedAt'> & { id?: string }): AllcheckDraweeResult {
    return new AllcheckDraweeResult({
      ...props,
      id: props.id ?? '',
      queriedAt: new Date(),
    });
  ...
  static reconstitute(props: AllcheckDraweeResultProps): AllcheckDraweeResult {
    return new AllcheckDraweeResult(props);
  }
}
