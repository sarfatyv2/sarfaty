...
export function ApproveRejectButtons({ reimbursementId, onSuccess }: ApproveRejectButtonsProps) {
  ...
  async function handleApprove() {
    try {
      await api.post(`/people/reimbursements/${reimbursementId}/approve`);
  ...
  async function handleRejectSubmit(data: RejectFormData) {
    try {
      await api.post(`/people/reimbursements/${reimbursementId}/reject`, {
        reason: data.reason,
      });
